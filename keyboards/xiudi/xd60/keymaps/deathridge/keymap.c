...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_all(
      ...
      _______, KC_LGUI, KC_LALT,                          KC_SPC,                          _______, KC_RALT, _______, KC_RCTL,  _______),

  [_FN] = LAYOUT_all(
      KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_INS,   KC_DEL,      \
      _______, RGB_TOG, RGB_MOD, RGB_HUI, RGB_VAD, RGB_VAI, RGB_SAD, RGB_SAI, KC_PSCR, _______, KC_PAUS, KC_UP,   _______, KC_BSPC,                 \
      ...
      _______, _______, KC_MPRV,                          KC_MPLY,                              _______, KC_MNXT, _______, _______, _______),
};
